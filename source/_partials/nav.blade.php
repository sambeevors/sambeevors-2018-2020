<a href="#" class="menu burger js-burger bg-white shadow lg:bg-transparent lg:shadow-none{{ $color_dodge ? ' color-dodge' : '' }}" aria-controls="navigation" role="button"><span><!-- --></span></a>
<nav id="navigation" class="nav js-nav flex justify-center items-center">
